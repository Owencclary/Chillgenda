...
const saveTaskType = (input) => { 
    taskType = input
    uncheckOtherCheckboxes(input) 
}
    ...
    try {
        ...
        for (let i = 0; i < todos.length; i++) {
            ...
            <tr class="todo-item" data-id="${todos[i].task_id}">
                <td>${todos[i].task}</td>
                <td style="color: ${todos[i].completed ? '#65C3C7' : '#A5ADBA'};">
                    ${todos[i].completed ? 'Completed' : 'Incomplete'}
                </td>
...
function openHomePage() {
    ...
    document.body.innerHTML = `
        ...
        <div class="checkboxes">
            <li class="item" class="date-input">
            ...
            <li class="item" >
                    ...
                    <label for="refresh">Refresh Task</label>
                <div class="tooltip">
            ...
            <li class="item">
                <input id="task-input" class="form__input" type="text" placeholder=". . ." class="input input-bordered input-secondary w-full max-w-xs" />
            </li>
            ...
            <div class="dropdown dropdown-left">
                <label tabindex="0" class="btn m-1 toggle-button" onclick="toggleDeleteTasksUI()">
                    <i class="bx bx-trash bx-xs"></i>
                </label>
            </div>
            </div>
            ...
            <div class="dropdown dropdown-left">
                ...
                <div class="checkboxes">
                    <li class="item">
                        <input onclick="saveTaskType('recreational')" id="recreational"  type="checkbox"/>
                        <label for="recreational">Recreational</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('social')" id="social" type="checkbox"/>
                        <label for="social">Social</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('music')" id="music" type="checkbox"/>
                        <label for="music">Music</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('education')" id="education" type="checkbox"/>
                        <label for="education">Education</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('busywork')" id="busywork" type="checkbox"/>
                        <label for="busywork">Busywork</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('relaxtion')" id="relaxation" type="checkbox"/>
                        <label for="relaxation">Relaxation</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('charity')" id="charity" type="checkbox"/>
                        <label for="charity">Charity</label>
                    </li>
                    <li class="item">
                        <input onclick="saveTaskType('cooking')" id="cooking" type="checkbox"/>
...
function showAlertMessage(message, type, location) {
    ...
    let alert_box = `
          <div id="alert" class="alert alert-${type} shadow-lg mb-5 w-full">
              <div>
                  <span>
                      ${message}
                  </span>
...
async function suggestATask() {
    try {
        ...
        if (response.ok) {
            ...
            showAlertMessage(data.activity, "success", "suggestion") 
        } else {
